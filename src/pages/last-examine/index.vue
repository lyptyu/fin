...
// 公积金地区点击处理
function handleProvidentFundAreaClick() {
...
// 格式化代发工资金额，保留两位小数
function formatSalaryAmount(flow: any) {
  if (flow.salaryAmount && flow.salaryAmount !== '') {
    const numVal = Number.parseFloat(flow.salaryAmount)
    if (!isNaN(numVal)) {
...
function formatInterest(flow: any, index: number) {
  if (flow.interest[index] && flow.interest[index] !== '') {
    const numVal = Number.parseFloat(flow.interest[index])
    if (!isNaN(numVal)) {
        ...
        <div class="module-content">
          ...
          <div class="section">
            ...
            <van-checkbox-group v-model="module1Data.blacklistOrgs" direction="horizontal" class="checkbox-group">
              ...
              <van-checkbox name="农行">
                农行
              </van-checkbox>
              <van-checkbox name="工行">
                工行
              </van-checkbox>
              <van-checkbox name="建行">
                建行
              </van-checkbox>
              <van-checkbox name="邮储">
                邮储
              </van-checkbox>
              <van-checkbox name="广发">
                广发
              </van-checkbox>
              <van-checkbox name="招行">
                招行
              </van-checkbox>
              <van-checkbox name="光大">
                光大
              </van-checkbox>
              <van-checkbox name="中信">
                中信
              </van-checkbox>
            </van-checkbox-group>
          ...
          <div class="section">
            ...
            <div class="form-item required">
              ...
              <van-radio-group v-model="module2Data.workType" direction="horizontal" class="radio-group">
                <van-radio name="普通单位上班族">
                  普通单位上班族
                </van-radio>
                <van-radio name="优质单位上班族">
                  优质单位上班族
                </van-radio>
                <van-radio name="企业主">
                  企业主
          ...
          <div class="section">
            ...
            <div class="form-item required">
              ...
              <template v-if="module2Data.hasSocialSecurity === '是'">
                <div class="radio-title required">
                  缴费主体：
                </div>
                <van-radio-group
                  ...
                  <template v-if="module2Data.hasProvidentFund === '是'">
                    <div class="form-item">
                      ...
                      <van-radio-group v-model="module2Data.providentFundCompanyType" direction="horizontal" class="radio-group">
                        ...
                        <van-radio name="不同于社保单位">
                          不同于社保单位
                        </van-radio>
                      </van-radio-group>
                    </div>
                    <div v-if="module2Data.providentFundCompanyType === '不同于社保单位'" class="form-item">
                      <van-field
                ...
                <template v-if="module2Data.socialSecurityPayer === '单位' && module2Data.socialSecurityCompany">
                  ...
                  <template v-if="module2Data.hasTax === '是'">
                    ...
                    <div v-if="module2Data.taxCompanyType === '不同于社保单位'" class="form-item">
                      <van-field
                ...
                <div class="house-block">
                  ...
                  <div class="form-item">
                    ...
                    <van-radio-group v-model="house.type" direction="horizontal" class="radio-group">
                      <van-radio name="商品房·住宅">
                        商品房·住宅
                      </van-radio>
                      <van-radio name="商品房·商业">
                        商品房·商业
                      </van-radio>
                      <van-radio name="非商品房">
                        非商品房
                ...
                <div class="flow-block">
                  ...
                  <div class="form-item">
                    ...
                    <van-radio-group v-model="flow.type" direction="horizontal" class="radio-group">
                      ...
                      <van-radio name="个人支付宝">
                        个人支付宝
                      </van-radio>
                      <van-radio name="对公">
                        对公
                      </van-radio>
                      <van-radio name="个人银行卡">
                        个人银行卡
                      </van-radio>
                    </van-radio-group>
                  </div>
                  ...
                  <template v-if="flow.type === '对公'">
                    <div class="form-item">
                      ...
                      <van-checkbox-group v-model="flow.features" direction="horizontal" class="checkbox-group">
                        <van-checkbox name="进账大">
                          进账大
                        </van-checkbox>
                        <van-checkbox name="结息大">
                          结息大
                        </van-checkbox>
                        <van-checkbox name="扣税记录">
                          扣税记录
                        </van-checkbox>
                        <van-checkbox name="代发工资记录">
                          代发工资记录
                        </van-checkbox>
                      </van-checkbox-group>
                    </div>
                  ...
                  <template v-if="flow.type === '个人银行卡'">
                    <div class="form-item">
                      ...
                      <van-checkbox-group v-model="flow.features" direction="horizontal" class="checkbox-group">
                        ...
                        <van-checkbox name="代发工资">
                          代发工资
                        </van-checkbox>
                        <van-checkbox name="固定转账">
                          固定转账
                        </van-checkbox>
                        <van-checkbox name="分红">
                          分红
                        </van-checkbox>
                      </van-checkbox-group>
                    </div>
                    <div v-if="flow.features.includes('代发工资')" class="form-item">
                      <van-field
      ...
      <van-cell-group inset class="module-group">
        ...
        <div class="module-content">
          ...
          <div class="section">
            ...
            <div class="form-item">
              <div class="radio-title">
                语言能力 <span style="color: #f56c6c">*</span>
              </div>
              <van-radio-group
              ...
              >
                <van-radio name="普通话和粤语都会">
                  普通话和粤语都会
                </van-radio>
                <van-radio name="只会普通话">
                  只会普通话
                </van-radio>
                <van-radio name="只会粤语">
                  只会粤语
                </van-radio>
                <van-radio name="普通话和粤语都不会">
                  普通话和粤语都不会
                </van-radio>
              </van-radio-group>
            </div>
          ...
          <div class="section">
            ...
            <div class="form-item">
              <div class="radio-title">
                写字能力 <span style="color: #f56c6c">*</span>
              </div>
              <van-radio-group
          ...
          <div class="section">
            ...
            <div class="form-item">
              <div class="radio-title">
                身体状况 <span style="color: #f56c6c">*</span>
              </div>
              <van-radio-group
