  ...
  <div class="authbook-wrap">
    <div ref="authbookRef" class="authbook">
      ...
      <div class="book-content">
        <h2>授权书</h2>
        <div class="book-main">
          <p>（甲方）____马上牛逼______有限公司</p>
          <p>本人（姓名（最终用户）：__福深________，身份证号：__2222________），拟向贵司申请：_____吹牛逼_____业务，审批需要的相关情况，用于（学籍、经营信息、风险管理、贷后管理等）及风控评估与控制，因此本人特同意并授权：</p>
          <ol>
